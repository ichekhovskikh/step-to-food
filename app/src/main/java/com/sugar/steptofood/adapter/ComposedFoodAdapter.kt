...
class ComposedFoodAdapter(context: Context,
    ...
    : BaseRecyclerAdapter<Food, ComposedFoodAdapter.RecipesViewHolder>(context) {

    @SuppressLint("InflateParams")
    override fun onCreateViewHolder(container: ViewGroup, viewType: Int): RecipesViewHolder {
        val foodCard = inflater.inflate(R.layout.item_products_card, null)
    ...
    override fun onBindViewHolder(holder: RecipesViewHolder, position: Int) {
        ...
        val products = food.products!!.sortedWith(compareBy { it.includedInSearch })
